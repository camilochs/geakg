"""Symbolic Rules: Domain-agnostic knowledge for L2 learned knowledge.

Symbolic rules are extracted from ACO training and used by the online
symbolic executor. They capture:
- WHEN to change strategy (not just probabilities)
- HOW to scale intensification
- WHEN to perturb (escape local optima)

NS-SE Principles:
- Abstract: Rules about ROLES, not specific operators
- Transferable: Same rules apply to any domain
- Interpretable: Explicit symbolic knowledge
